var PHASE_WORDS = {
  ...
  2: ['flag','glad','half','flash','slash','lash','gash','hash',
      ...
      'shag','glad','flags','glads','halfs','dashes','lashes'],
  3: ['slide','files','like','side','hide','life','field','held',
      'self','else','flesh','shelf','deal','heal','idea','ideal',
      'deals','heals','eagle','shield','diesel','gleeful','ailed',
      'aside','files','sailed','failed','aisle','daily'],
